-- CreateEnum
CREATE TYPE "OrderSource" AS ENUM ('WHATSAPP', 'INSTAGRAM', 'FACEBOOK', 'PHONE', 'WALK_IN');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('ORDERED', 'PROCESSING', 'SHIPPED', 'DELIVERED', 'CANCELLED');
